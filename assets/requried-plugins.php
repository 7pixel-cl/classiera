...
function classiera_register_required_plugins(){
    ...
    $plugins = array(
		...
		===========================*/
		array(           
            'name' => esc_html__( 'Elementor Website Builder', 'classiera' ),
            'slug' => 'elementor',
            'required' => false,
            'force_activation' => false,
            'force_deactivation' => false
		...
		===========================*/		
		array(            
			'name' => esc_html__( 'Classiera Elementor', 'classiera' ),
            'slug' => 'classiera-elementor',
            'required' => false,
            'version' => '1.0.0',
            'force_activation' => false,
            'force_deactivation' => false,
            'source' => 'https://s3.amazonaws.com/joinwebs/plugins/classiera-elementor.zip',
        ),
    );    
	$config = array(
		'id'           => 'classiera',
