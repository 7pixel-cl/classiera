...
global $redux_demo, $nameError, $emailError, $commentError, $subjectError, $humanTestError, $user_ID, $wp_rewrite;
						...
						<div class="author-social">
							...
							<div class="author-social-icons">
								<ul class="list-unstyled list-inline">
									...
									<li>
										<a href="<?php echo esc_url($userFacebook); ?>" target="_blank">
									...
									<li>
										<a href="<?php echo esc_url($usertwitter); ?>" target="_blank">
									...
									<li>
										<a href="<?php echo esc_url($usergoogleplus); ?>" target="_blank">
									...
									<li>
										<a href="<?php echo esc_url($userpinterest); ?>" target="_blank">
									...
									<li>
										<a href="<?php echo esc_url($userlinkedin); ?>" target="_blank">
