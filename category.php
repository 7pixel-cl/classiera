...
$cat_sidebar_adv = '';
$cat_top_adv = '';
if (isset($tag_extra_fields[$cat_id])) {	
	if(isset($tag_extra_fields[$cat_id]['cat_top_adv'])){
		$cat_top_adv = $tag_extra_fields[$cat_id]['cat_top_adv'];
	}
	if(isset($tag_extra_fields[$cat_id]['cat_sidebar_adv'])){
		$cat_sidebar_adv = $tag_extra_fields[$cat_id]['cat_sidebar_adv'];
	}
	if(isset($tag_extra_fields[$cat_id]['cat_shortcode_top'])){
		$cat_shortcode_top = $tag_extra_fields[$cat_id]['cat_shortcode_top'];
	}
	if(isset($tag_extra_fields[$cat_id]['cat_shortcode_side'])){
		$cat_shortcode_side = $tag_extra_fields[$cat_id]['cat_shortcode_side'];
	}
}
	/*== Google MAP ==*/
	...
	<div class="container">
		<div class="row">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 center-block text-center">
								...
								if(function_exists('do_shortcode')) {
									echo do_shortcode($cat_shortcode_top);
								}
								?>
							</div>
						</div>
			...
			<div class="col-md-4 col-lg-3">
				<aside class="sidebar">
					<div class="row">
						<?php if(!empty($cat_sidebar_adv)){ ?>
						<div class="col-lg-12 col-md-12 col-sm-6 match-height">
							<div class="widget-box">
								<div class="textwidget text-center">
								<?php
								if(function_exists('classiera_escape')) {
									classiera_escape($cat_sidebar_adv);
								}
								?>
								</div>
							</div>
						...
						<?php } ?>
						<?php if(!empty($cat_shortcode_side)){ ?>
						<div class="col-lg-12 col-md-12 col-sm-6 match-height">
							<div class="widget-box">
								<div class="textwidget text-center">
								<?php
								if(function_exists('do_shortcode')) {
									echo do_shortcode($cat_shortcode_side);
								}
								?>
								</div>
							</div>
