	...
	<div class="comment-form">
		...
		<div class="comment-form-heading">
			...
			<div class="alert alert-danger comment-error-login">
				<?php esc_html_e('Sorry, you must be logged in to comment', 'classiera') ?>
			</div>
		</div>
		<!--Form-->
				...
				<div class="form-inline row">
					...
					<div class="form-group col-sm-7">
						...
						<div class="inner-addon left-addon">
							<input type="text" name="author" class="form-control form-control-sm" placeholder="<?php esc_attr_e( 'Enter name','classiera' ); ?>" data-error="<?php esc_attr_e( 'name required','classiera' ); ?>" required value="<?php echo esc_attr( $comment_author ); ?>">
					...
					<div class="form-group col-sm-7">
						...
						<div class="inner-addon left-addon">
							<input type="text" name="email" class="form-control form-control-sm" placeholder="<?php esc_attr_e( 'Enter email','classiera' ); ?>" data-error="<?php esc_attr_e( 'email required','classiera' ); ?>" required value="<?php echo esc_attr( $comment_author_email ); ?>">
							<div class="help-block with-errors"></div>
						</div>
					</div><!--eMAIL-->
					<div class="form-group col-sm-7">
						...
						<div class="inner-addon left-addon">
							<input type="url" name="url" class="form-control form-control-sm" placeholder="<?php esc_attr_e( 'enter website url','classiera' ); ?>" value="<?php echo esc_attr( $comment_author_url ); ?>">
						</div>
					</div><!--Phone-->
					<?php } ?>
					<div class="form-group col-sm-12">
						<label class="text-capitalize"><?php esc_html_e( 'Comment','classiera' ); ?> : <span class="text-danger">*</span></label>
						<div class="inner-addon">
							<textarea data-error="<?php esc_attr_e( 'Type your comment here', 'classiera') ?>" name="comment" placeholder="<?php esc_attr_e( 'Type your comment here...', 'classiera') ?>" required></textarea>
							<div class="help-block with-errors"></div>
						</div>
					</div><!--Message-->
				</div>
