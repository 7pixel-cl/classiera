			...
			<div class="col-lg-6 col-sm-6">
				...
				<?php }elseif($classieraFooterBottomStyle == 'icon'){
					...
					<ul class="footer-bottom-social-icon">
						...
						<li>
							<a href="<?php echo esc_url($classieraLinkedin); ?>" class="rounded text-center" target="_blank">
...
if(is_user_logged_in() && function_exists('classiera_helper_scripts')){
...
?>
	<a href="<?php echo esc_url($classieraInbox); ?>" class="bid_notification">
		...
		<span class="bid_notification__count"><?php echo esc_html($classieraRead); ?></span>
	</a>
<?php
	}
}
