...
// Retrieve the URL variables (using PHP).
	...
	if(isset($redux_demo)){
		...
		$classieraAdvPos = $redux_demo['classiera_adv_seacrh_pos'];
	...
	if(isset($_GET['post_location'])){
		...
		if(function_exists('classiera_location_query')){
			$searchQueryCountry = classiera_location_query($country);
		}				
	}	
	if(isset($_GET['post_state'])){
		$state = $_GET['post_state'];
		if(function_exists('classiera_location_query')){
			$searchQueryStates = classiera_location_query($state);
		}	
	}	
	if(isset($_GET['post_city'])){
		$city = $_GET['post_city'];
		if(function_exists('classiera_location_query')){
			$searchQueryCity = classiera_location_query($city);
		}		
	}
...
<section class="inner-page-content border-bottom top-pad-50">
	<div class="container">
        <div class="row">
			<?php if($classieraAdvPos == 'top'){ ?>
			<div class="col-lg-12">
				<?php get_template_part( 'templates/classiera-adv-search-top' );?>
			</div>
			<?php }else{ ?>
			...
			<!--EndSidebar-->
			<!--ContentArea-->
			<div class="<?php if($classieraAdvPos == 'top'){ echo "col-md-12";}else{ echo "col-lg-9 col-md-8";}?>">
