...
$classieraPriceSection = false;
$classiera_bid_system = false;
$relatedAdsOn = true;
...
<section class="inner-page-content single-post-page">
	<div class="container">
		...
		<?php
		$classiera_padv1 = get_post_meta($post->ID, 'classiera_padv1', true);
		if(!empty($classiera_padv1)){ ?>
		<section id="classieraDv">
			<div class="container">
				<div class="row">							
					<div class="col-lg-12 col-md-12 col-sm-12 center-block text-center">
					<?php
					if(function_exists('classiera_escape')) {
						classiera_escape($classiera_padv1);
					}
					?>
					</div><!--col-lg-12-->
				</div><!--row-->
		...
		<?php } ?>
		<?php
		$classiera_padv3 = get_post_meta($post->ID, 'classiera_padv3', true);
		if(!empty($classiera_padv3)){ ?>
		<section id="classieraDv">
			<div class="container">
				<div class="row">							
					<div class="col-lg-12 col-md-12 col-sm-12 center-block text-center">
					...
					if(function_exists('do_shortcode')) {
						echo do_shortcode($classiera_padv3);
					}
					?>
					</div><!--col-lg-12-->
				</div><!--row-->
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="single-post">
                        ...
                        <div class="post-details">
                            <ul class="list-unstyled clearfix">
								...
								<li>
									...
									<span class="pull-right flip"><?php echo esc_html($post_location); ?></span>
									</p>
                                </li><!--Location-->
								<?php } ?>
								...
								<li>
									...
									<span class="pull-right flip"><?php echo esc_html($post_state); ?></span>
									</p>
                                </li><!--state-->
								<?php } ?>
								...
								<li>
									...
									<span class="pull-right flip"><?php echo esc_html($post_city); ?></span>
									</p>
                                </li><!--City-->
								<?php } ?>								
									...
									for ($i = 0; $i < count($classieraCustomFields); $i++){
										if( !isset($classieraCustomFields[$i][2]) || $classieraCustomFields[$i][2] == 'text'){
											if(!empty($classieraCustomFields[$i][1]) && !empty($classieraCustomFields[$i][0]) ) {
												?>
											<li>
												<p class="clearfix"><?php echo esc_html($classieraCustomFields[$i][0]); ?>: 
												<span class="pull-right flip">
					...
					global $redux_demo;
					if(isset($redux_demo)){
						$singleAdImg1 = $redux_demo['single_ad2']['url']; 
						$singleAdImglink1 = $redux_demo['single_ad2_url']; 
						$singleHTMLAds = $redux_demo['single_html_ad2'];
					}				
					if(!empty($singleHTMLAds) || !empty($singleAdImg1)){
					?>
							...
							<div class="row">							
								<div class="col-lg-12 col-md-12 col-sm-12 center-block text-center">						
									...
									if(!empty($singleHTMLAds)){
										...
										echo '<a href="'.esc_url($singleAdImglink1).'" onclick="<script>tracking() </script>" target="_blank"><img class="img-responsive" alt="image" src="'.esc_url($singleAdImg1).'" /></a>';
									}
									?>
									<a class = 'banner-ad-label-top' href="https://api.whatsapp.com/send?phone=56953535153&text=Hola,+estoy+interesado+en+publicitar+en+Necesito+en+Villarrica" target="_blank">Anuncia con nosotros >
									<i class="fab fa-whatsapp"></i> 
			...
			<div class="col-md-4">
				<aside class="sidebar">
					<div class="row">
						<?php
						$classiera_padv2 = get_post_meta($post->ID, 'classiera_padv2', true);
						if(!empty($classiera_padv2)){ ?>
						<div class="col-lg-12 col-md-12 col-sm-6 match-height">
							<div class="widget-box">
								<div class="textwidget text-center">
									<?php
									if(function_exists('classiera_escape')) {
										classiera_escape($classiera_padv2);
									}
									?>
								</div>								
							</div>
						...
						<?php } ?>
						<?php
						$classiera_padv4 = get_post_meta($post->ID, 'classiera_padv4', true);
						if(!empty($classiera_padv4)){ ?>
						<div class="col-lg-12 col-md-12 col-sm-6 match-height">
							<div class="widget-box">
								<div class="textwidget text-center">
									<?php
									if(function_exists('do_shortcode')) {
										echo do_shortcode($classiera_padv4);
									}
									?>
								</div>								
							</div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="media-heading text-uppercase">
													<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo esc_html($authorName); ?></a>
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<div class="alert alert-success">
															<?php esc_html_e('Your message successfully sent to the seller.', 'classiera') ?>
														</div>
														<?php } ?>
													</div>
												</div>
							...
							<div class="widget-box <?php if($classieraSingleAdStyle == 2){echo "border-none";}?>">
								...
								<div class="widget-content widget-content-post">
                                    <div class="share widget-content-post-area">
                                        <h5><?php echo esc_html($post_map_location); ?></h5>
                                        <?php if(!empty($post_latitude)){?>
										<div id="classiera_single_map">
