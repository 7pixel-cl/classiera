...
<?php 
	...
	if($classieraCategoriesStyle == 1){
		...
		get_template_part( 'templates/categoriesstyle/catstyle8' );
	}elseif($classieraCategoriesStyle == 9){
		get_template_part( 'templates/categoriesstyle/catstyle9' );
	}elseif($classieraCategoriesStyle == 10){
		get_template_part( 'templates/categoriesstyle/catstyle10' );
	}
	//Patners Styles//	
