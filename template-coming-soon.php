...
<?php  wp_head(); ?>
	<style type="text/css">
        ...
        .comingSoon__content .comingSoon__logo img{
            margin:0 auto;
        }
...
?>
                ...
                <div class="col-md-12">
                    <div class="comingSoon__content text-center">
                        <div class="comingSoon__logo">
                            ...
                            <h3><?php echo esc_html($comingtxt); ?></h3>
                        </div>
                        ...
                        <div class="comingSoon__Social">
							...
							<a href="<?php echo esc_url($google_plus_link); ?>" target="_blank"><i class="fab fa-google-plus-g"></i></a>
							<a href="<?php echo esc_url($instagram_link); ?>" target="_blank"><i class="fab fa-instagram"></i></a> 
                        </div>
	...
	<script type="text/javascript" src="<?php echo esc_url(get_template_directory_uri()); ?>/js/countdown.js"></script>
	<?php wp_footer(); ?>
