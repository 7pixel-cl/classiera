						...
						<div class="form-inline row">
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="name" type="text" name="contactName" class="form-control form-control-md" placeholder="<?php esc_attr_e( 'Enter your full name', 'classiera' ); ?>" data-error="<?php esc_attr_e( 'Name Required', 'classiera' ); ?>" required>
							...
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="email" type="text" name="email" class="form-control form-control-md" placeholder="<?php esc_attr_e( 'Enter your email', 'classiera' ); ?>" data-error="<?php esc_attr_e( 'Email required', 'classiera' ); ?>" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div><!--Email-->
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="phone" type="text" name="phone" class="form-control form-control-md" placeholder="<?php esc_attr_e( 'Enter your phone number', 'classiera' ); ?>">
                                </div>
                            </div><!--Phone Div-->
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="subject" name="subject" type="text" class="form-control form-control-md" placeholder="<?php esc_attr_e( 'Enter Subject', 'classiera' ); ?>" data-error="<?php esc_attr_e( 'Subject Requried', 'classiera' ); ?>" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div><!--Subject Div-->
							<div class="form-group col-sm-12">
                                ...
                                <div class="inner-addon">
                                    <textarea data-error="<?php esc_attr_e( 'Please type message', 'classiera' ); ?>" name="comments" id="text" placeholder="<?php esc_attr_e( 'Type your message here...!', 'classiera' ); ?>" required></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div><!--Message Div-->
							<?php 
							...
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="humanTest" type="text" name="humanTest" class="form-control form-control-md" placeholder="<?php esc_attr_e('Your Answer', 'classiera'); ?>" data-error="<?php esc_attr_e( 'Security Answer Required', 'classiera' ); ?>" required>
                                    <div class="help-block with-errors"></div>
							...
							<div class="form-group col-sm-12">
								<div class="inner-addon left-addon">
									<div class="checkbox">
										<input type="checkbox" name="gdpr" id="gdpr" value="gdpr" required>
										<label for="gdpr">
