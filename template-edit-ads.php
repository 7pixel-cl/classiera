...
$hasError = false;
$googleFieldsOn = false;
$post_whatsapp_on = true;
$classieraLatitude = '';
$classieraLongitude = '';
$postCurrency = '';
$classieraAddress = '';
$classiera_ads_typeOn = '';
$termsandcondition = '';
$classiera_locations_input = 'dropdown';
$classiera_bid_system = true;
$regularpriceon = true;
$classieraAskingPhone = true;
$adpostCondition = true;
$adsTypeShow = '';
$classieraPriceSecOFF = true;
$classieraMultiCurrency = 'single';
$paidIMG = 3;
$regularIMG = 3;
$classiera_video_postads = true;
$locationsStateOn = true;
$locationsCityOn = true;
$googleMapadPost = true;
$regular_ads = true;
...
$args = array(
	'post_type' => 'post',
	'post_status' => array('publish', 'pending', 'draft', 'trash', 'private', 'expired', 'future', 'rejected'),
	'posts_per_page' => '1',
	'p' => $_GET['post'],
);
...
if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post();
	if(isset($_GET['post'])) {
		if($_GET['post'] == $post->ID){
			...
			$post_defect = get_post_meta($post->ID, 'post_defect', true);
					...
					<form class="form-horizontal" action="" role="form" id="primaryPostForm" method="POST" data-toggle="validator" enctype="multipart/form-data">
						...
						<div class="form-main-section post-detail">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input id="title" data-minlength="5" name="postTitle" type="text" class="form-control form-control-md" value="<?php echo esc_html($title); ?>" placeholder="<?php esc_attr_e('Ad Title Goes here', 'classiera') ?>" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea name="postContent" id="description" class="form-control" data-error="<?php esc_attr_e('Write description', 'classiera') ?>" required><?php echo esc_html($content);?></textarea>
									...
									<div class="form-inline row">
										...
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="post_price" value="<?php echo esc_html($post_price); ?>" class="form-control form-control-md" placeholder="<?php esc_attr_e('Sale price', 'classiera') ?>">
											</div>
										</div><!--col-sm-6-->
										<!--Regular Price-->
										...
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="post_old_price" value="<?php echo esc_attr($post_old_price); ?>" class="form-control form-control-md" placeholder="<?php esc_attr_e('Regular price', 'classiera') ?>">
											</div>
										</div>
										<?php } ?>
									</div><!--form-inline row-->
                                    ...
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="post_phone" value="<?php echo esc_html($post_phone); ?>" class="form-control form-control-md" placeholder="<?php esc_attr_e('Enter your phone number or Mobile number', 'classiera') ?>">
                                            </div><!--input-group-->
                                        </div><!--col-sm-12-->
                                    </div><!--form-inline row-->
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="radio">
                                        <input id="no_defect" type="radio" name="post_defect" value="no_defect" <?php if($post_defect == 'no_defect'){echo "checked";}?>>
                                        <label for="new"><?php esc_html_e('No defect', 'classiera') ?></label>
                                        <input id="minor_defect" type="radio" name="post_defect" value="minor_defect" <?php if($post_defect == 'minor_defect'){echo "checked";}?>>
                                        <label for="used"><?php esc_html_e('Minor defect', 'classiera') ?></label>
										<input id="major_defect" type="radio" name="post_defect" value="major_defect" <?php if($post_defect == 'major_defect'){echo "checked";}?>>
                                    </div>
                                </div>
                            </div>
							<!--AD Defect -->
										...
										<div class="col-sm-6">
											<div class="inner-addon right-addon">
												...
												<div class="checkbox">
													...
													<label for="<?php echo esc_html($thisCatID); ?>custom_field[<?php echo esc_attr($i); ?>][1]" class="newcehcklabel"><?php echo esc_html($classieraCategoryFields[$i][0]); ?></label>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="form-main-section media-detail">
							...
							$imageLimit = $imageLimit - count($attachments);
							?>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<!--Video-->
									<?php 
									$allowVideoPosting = true;
									$classiera_video_postads = $redux_demo['classiera_video_postads'];
									$classiera_video_paid = $redux_demo['classiera_video_paid'];
									if($classiera_video_paid == true){
										if($featuredAvailable == 0 && $regularAvailable == 0){
											$allowVideoPosting = false;
										}else{
											$allowVideoPosting = true;
										}
									}else{
		...
		classiera_editdropzone.dropzone ({
			...
			init: function() {
				...
				this.on("removedfile", function(file) {
					var imagecount = jQuery('#classiera_editdropzone')[0].dropzone.options.maxFiles + 1;
					jQuery('#classiera_editdropzone')[0].dropzone.options.maxFiles = imagecount;
					//console.log(jQuery('#classiera_editdropzone')[0].dropzone.options.maxFiles);
