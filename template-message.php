				...
				<div class="user-detail-section section-bg-white">
					...
					<div class="user_inbox_content">
						<div class="tab-content">
							<span class="classiera--loader"><img src="<?php echo esc_url(get_template_directory_uri()).'/images/loader180.gif' ?>" alt="classiera loader"></span>
							<?php 
							global $wpdb;
							global $post;
							global $firstPostId;
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content classiera_comment_ajax">
															...
															<form method="post" id="resetReply" class="classiera_user_message__form">
																<textarea class="form-control classiera_comment_reply" placeholder="<?php esc_attr_e( "Type your message..", "classiera" )?>" required></textarea>
											...
											<li <?php if($count == 1){ ?> class="active" <?php }?>>
                                                <a class="user_comment comment_rec" href="#" id="<?php echo esc_attr( $offer_post_id ); ?>">
                                                    ...
                                                    <div class="user_comment_number">
														...
														<span><?php echo esc_html( $totalBids); ?></span>
