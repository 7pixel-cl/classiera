			...
			<div class="col-lg-9 col-md-8 user-content-height">
				<div class="user-detail-section section-bg-white">
					...
					<div class="user-social-profile-links">
						...
						<?php if(!empty($userFB)){?>
                            <li>
                                <a href="<?php echo esc_url( $userFB ); ?>" target="_blank">
						...
						<?php if(!empty($userTW)){?>
                            <li>
                                <a href="<?php echo esc_url( $userTW ); ?>" target="_blank">
						...
						<?php if(!empty($userGoogle)){?>	
                            <li>
                                <a href="<?php echo esc_url( $userGoogle ); ?>" target="_blank">
						...
						<?php if(!empty($userInsta)){?>	
                            <li>
                                <a href="<?php echo esc_url( $userInsta ); ?>" target="_blank">
						...
						<?php if(!empty($userPin)){?>	
                            <li>
                                <a href="<?php echo esc_url( $userPin ); ?>" target="_blank">
						...
						<?php if(!empty($userLin)){?>	
                            <li>
                                <a href="<?php echo esc_url( $userLin ); ?>" target="_blank">
						...
						<?php if(!empty($userVimeo)){?>	
                            <li>
                                <a href="<?php echo esc_url( $userVimeo ); ?>" target="_blank">
						...
						<?php if(!empty($userYouTube)){ ?>	
                            <li>
                                <a href="<?php echo esc_url( $userYouTube ); ?>" target="_blank">
						...
						<?php if(!empty($digg)){ ?>	
                            <li>
                                <a href="<?php echo esc_url( $digg ); ?>" target="_blank">
						...
						<?php if(!empty($lastfm)){ ?>	
                            <li>
                                <a href="<?php echo esc_url( $lastfm ); ?>" target="_blank">
					...
					<div class="user-ads user-my-ads">
						...
						<?php 
							...
							$kulPost = array(
								...
								'author' => $user_id,
								'posts_per_page' => 10,	
								'post_status' => array( 'publish', 'pending', 'future', 'draft', 'private', 'expired', 'rejected'),
							);
