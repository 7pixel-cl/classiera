...
$featuredADS = '';
$catStyle ="box";
$classieracat_icon = "awesome_icons";
$primaryColor ="#b6d91a";
$postCurrency ="$";
$termsandcondition ="";
$classiera_gdpr_url ="";
$classiera_image_size ="1";
$classieraLatitude ="31.516370";
$classieraLongitude ="74.258727";
$classiera_locations_input ="dropdown";
$classiera_google_api ="";
$post_whatsapp_on = true;
$googleFieldsOn = true;
$classieraAddress = true;
...
$featuredAvailable = 0;
if(isset($redux_demo)){
	$catStyle = $redux_demo['classiera_submit_cat_style'];
...
if(isset($_POST['postTitle'])) {
	if(trim($_POST['postTitle']) != '' && $_POST['classiera-main-cat-field'] != '') {
		...
		if(isset($_POST['submitted']) && isset($_POST['post_nonce_field']) && wp_verify_nonce($_POST['post_nonce_field'], 'post_nonce')) {
			...
			/*== Image Count check ==*/
			if(!is_super_admin() && empty($_POST['classiera_post_type'])){
				$hasError = true;
			}
			if($hasError == false) {
		...
		<div class="row">
			<div class="col-lg-12 user-content-height">
				...
				if($authorVerified != 'verified'){ ?>
					<div class="alert alert-warning" role="alert">
						<p>
						<?php esc_html_e('You have not verified your account, please go to', 'classiera') ?>&nbsp;&nbsp;<a class="btn btn-primary btn-sm" href="<?php echo esc_url( $classieraProfileSetting ); ?>"><?php esc_html_e('Profile Settings', 'classiera') ?></a>
				...
				<div class="submit-post submit-post-v2 section-bg-white">
					<form class="form-horizontal" action="" role="form" id="primaryPostForm" method="POST" data-toggle="validator" enctype="multipart/form-data">
						...
						<?php
						if($catStyle == 'dropdown'){
							get_template_part( 'templates/cat-submit-dropdown-v2' );
						}else{
						?>
						<!--Category-->
										...
										<ul class="list-unstyled list-inline">
											...
											foreach ($categories as $category){
												...
												if (isset($classieraCatFields[$tag])){
													if(isset($classieraCatFields[$tag]['category_imagecode'])){
														$classieraCatIconCode = $classieraCatFields[$tag]category_imagen_code'];
													}
										...
										<div class="col-lg-3 col-md-4 col-sm-5 active-post-type">
											<div class="post-type-box">
                                                <div class="radio">
                                                    ...
                                                    <label for="no_defect"><?php esc_html_e('No defect', 'classiera') ?></label>
                                                </div>
                                            </div>
										</div><!--col-lg-3-->
										<div class="col-lg-3 col-md-4 col-sm-5">
											<div class="post-type-box">
                                                <div class="radio">
                                                    ...
                                                    <label for="minor_defect"><?php esc_html_e('Minor defect', 'classiera') ?></label>
                                                </div>
                                            </div>
										</div><!--col-lg-3-->
										<div class="col-lg-3 col-md-4 col-sm-5">
											<div class="post-type-box">
                                                <div class="radio">
                                                    ...
                                                    <label for="major_defect"><?php esc_html_e('Major defect', 'classiera') ?></label>
                                                </div>
                                            </div>
										</div><!--col-lg-3-->
									</div><!--form-inline-->
						...
						<div class="form-main-section media-detail">
                            ...
                            <h4 class="border-bottom">
								<?php esc_html_e('Image And Video', 'classiera') ?> :
							</h4>
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-9">
									...
									if($allowVideoPosting == true && $classiera_video_postads == true){
									?>
                                    <div class="iframe">
						...
						<div class="form-main-section post-location">
							...
							<!--Select Country-->
							<div class="form-group">
                                <label class="col-sm-3 control-label"><?php esc_html_e('Select Country', 'classiera') ?>:</label>
							...
							if($locationsStateOn == 1){
								...
								?>
								<div class="form-group">
									<label class="col-sm-3 control-label"><?php esc_html_e('Select State', 'classiera') ?>: </label>
									<div class="col-md-4 col-sm-6">
										<div class="inner-addon right-addon input-group">
											<div class="input-group-addon">
												<i class="fas fa-globe"></i>
							...
							if($locationsCityOn == 1){
								...
								?>
								<div class="form-group">
									<label class="col-sm-3 control-label"><?php esc_html_e('Select City', 'classiera'); ?>:</label>
									<div class="col-md-4 col-sm-6">
										<div class="inner-addon right-addon input-group">
											<div class="input-group-addon">
												<i class="fas fa-globe"></i>
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label"><?php esc_html_e('Address', 'classiera'); ?> :</label>
                                <div class="col-sm-6">
									<div class="form-inline row">
										<div class="col-sm-12">
											<div class="input-group">
						...
						<div class="form-main-section post-type">
                            <h4 class="border-bottom"><?php esc_html_e('Select Ad Post Type', 'classiera') ?> :</h4>
