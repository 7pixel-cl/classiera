...
<section class="user-pages section-gray-bg">
	<div class="container">
		<div class="row">
				...
				<div class="submit-post section-bg-white">
					<form class="form-horizontal" action="" role="form" id="primaryPostForm" method="POST" data-toggle="validator" enctype="multipart/form-data">
						...
						if($catStyle == 'dropdown'){
							get_template_part( 'templates/cat-submit-dropdown' );
						}else{
						?>
						<!--Category-->
						<div class="form-main-section classiera-post-cat">
							<div class="classiera-post-main-cat">
								...
								<ul class="list-unstyled list-inline">
									...
									foreach ($categories as $category){category_image
										$tag = $category->term_id;category_image
						...
						<div class="form-main-section post-detail">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="help-block with-errors"><?php esc_html_e('Write description', 'classiera') ?></div>
                                </div>
                            </div><!--Ad description-->
							<div class="form-group">
                                    ...
                                    <div class="form-inline row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="post_tags" class="form-control form-control-md" placeholder="<?php esc_attr_e('Enter keywords for a better search', 'classiera') ?>">
                                            </div>
                                        </div>
                                    </div>
						...
						<div class="form-main-section post-location">
							...
							<div class="form-group">
                                <label class="col-sm-3 text-left flip"><?php esc_html_e('Address', 'classiera'); ?> :</label>
								<div class="col-sm-9">
									<div class="form-inline row">
										<div class="col-sm-12">
											<div class="input-group">
			...
			</div><!--col-lg-9 col-md-8 user-content-height-->
		</div><!--row-->
	</div><!--container-->
</section><!--user-pages-->
<?php endwhile; ?>
