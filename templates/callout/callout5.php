...
global $redux_demo;
$classieraCTABG = '';
$classieraCTAAboutIcon = '';
$classieraCTAAboutTitle = '';
$classieraCTAAboutDesc = '';
$classieraCTASellIcon = '';
$classieraCTASellTitle = '';
$classieraCTASellDesc = '';
$classieraCTABuyIcon = '';
$classieraCTABuyTitle = '';
$classieraCTABuyDesc = '';
$classieraParallax = '';
if(isset($redux_demo)){
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="call-to-action-box match-height">
                    <div class="action-box-heading">
                        ...
                        <div class="heading-content">
                            <h3><?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTAAboutTitle); } ?></h3>
                        </div>
                    </div>
                    <div class="action-box-content">
                        <p>
                            <?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTAAboutDesc); } ?>
                        </p>
                    </div>
                </div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="call-to-action-box match-height">
                    <div class="action-box-heading">
                        ...
                        <div class="heading-content">
                            <h3><?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTASellTitle); } ?></h3>
                        </div>
                    </div>
                    <div class="action-box-content">
                        <p>
                            <?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTASellDesc); } ?>
                        </p>
                    </div>
                </div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
                <div class="call-to-action-box match-height">
                    <div class="action-box-heading">
                        ...
                        <div class="heading-content">
                            <h3><?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTABuyTitle); } ?></h3>
                        </div>
                    </div>
                    <div class="action-box-content">
                        <p>
                            <?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTABuyDesc); } ?>
                        </p>
                    </div>
                </div>
