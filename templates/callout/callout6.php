		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-7 col-sm-12">
				<div class="member-content">
					<h3><?php if(function_exists('classiera_escape')) { classiera_escape($calloutTitle); } ?></h3>
					...
					<ul class="fa-ul list-unstyled">
						...
						<li>
							...
							<?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTAAboutTitle); } ?>
						</li>
						<?php } ?>
						<?php if(!empty($classieraCTASellIcon)){?>
						<li>
							<span><img class="svg" src="<?php echo esc_url($classieraCTASellIcon); ?>"></span>
							<?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTASellTitle); } ?>
						</li>
						<?php } ?>
						<?php if(!empty($classieraCTABuyIcon)){?>
						<li>
							<span><img class="svg" src="<?php echo esc_url($classieraCTABuyIcon); ?>"></span>
							<?php if(function_exists('classiera_escape')) { classiera_escape($classieraCTABuyTitle); } ?>
						</li>
						<?php } ?>
					</ul>
					<h4><?php if(function_exists('classiera_escape')) { classiera_escape($calloutTitlesecond); } ?></h4>
