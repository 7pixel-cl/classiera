						...
						<div class="category-box border">
							...
							<div class="category-content">
								...
								<div class="view-button">
									<a href="<?php echo esc_url(get_category_link( $mainID )) ?>" class="btn btn-primary sharp btn-style-one btn-sm"><?php esc_html_e( 'VIEW ALL', 'classiera' ); ?><i class="fas fa-chevron-right icon-right"></i></a>
								</div>
							</div>
						</div>
					</div>
