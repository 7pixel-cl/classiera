							...
							<div class="<?php echo esc_attr($classieraClass);?> col-sm-6">
								<figure class="location">
									...
									<figcaption>
										...
										<div class="location-caption">
											<h4>
												<a href="<?php echo esc_url($locationURL.$countryName);?>">
													<?php echo esc_attr($countryName); ?>
												</a>
											</h4>
											<p>
												<?php 
											...
											<a href="<?php echo esc_url($locationURL.$countryName);?>"><?php esc_html_e( 'View all ads', 'classiera' ); ?> <i class="fas fa-long-arrow-alt-<?php if(is_rtl()){echo "left";}else{echo "right";}?>"></i></a>
										</div>
									</figcaption>
								</figure>
							</div>
