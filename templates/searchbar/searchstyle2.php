				...
				<form data-toggle="validator" role="search" class="search-form search-form-v2 form-inline" action="<?php echo esc_url(home_url()); ?>" method="get">
					...
					<div class="form-group clearfix">
						...
						<div class="side-by-side-input pull-left flip classieraAjaxInput">
							<input type="text" name="s" class="form-control form-control-sm" <?php if($classiera_remove_ajax == 1){ ?>id="classieraSearchAJax" <?php } ?> placeholder="<?php esc_attr_e( 'Enter keyword...', 'classiera' ); ?>" data-error="<?php esc_attr_e( 'Please Type some words..!', 'classiera' ); ?>">
					...
					<div class="form-group">
                        <div class="input-group inner-addon right-addon">
							...
							<?php if($classieraLocationType == 'input'):?>
								<input type="text" id="getCity" name="<?php echo esc_attr($classieraLocationName); ?>" class="form-control form-control-sm" placeholder="<?php esc_attr_e('type your location', 'classiera'); ?>">
