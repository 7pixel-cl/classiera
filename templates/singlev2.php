	...
	<div class="col-lg-6 col-md-6">
		<div class="single-post">
			...
			<div class="single-post-title">
				<h1 class="text-uppercase h4"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
				...
				<?php $category = get_the_category(); ?>
					...
					<span>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>?s=&<?php echo esc_html($locShownBy);?>=<?php echo esc_html($post_location);?>">
